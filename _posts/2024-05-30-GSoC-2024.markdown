---
layout: post
title:  "GSoC 24: My First Issue and Contribution"
...
I had originally sent a patch fixing this bug to the development mailing list, but it didn't get reviewed. However, I did get the changes in the codebase once the RTEMS project migrated to GitLab (which happened together with the start of GSoC 2024). Following are both the merge requests associated with the fix:
